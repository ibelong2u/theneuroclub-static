...
*/
require(['jquery','videopopup'],function($){$.fn.grtyoutube=function(options){return this.each(function(){var getvideoid=$(this).closest('div').attr('id');var settings=$.extend({videoID:getvideoid,autoPlay:true,theme:"dark"},options);if(settings.autoPlay===true){settings.autoPlay=1}else if(settings.autoPlay===false){settings.autoPlay=0}
